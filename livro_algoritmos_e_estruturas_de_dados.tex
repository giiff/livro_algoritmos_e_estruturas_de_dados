...
Exemplos disso são os algoritmos de localização e rotas para endereços, como o aparelho deGPS de um carro, ou ainda a montagem de genomas a partir de fragmentos de DNA sequenciados.
...
Vejamos um exemplo. Seja o conjunto $V = {a, b, c, d, e}$. Seja o conjunto $E = {(a, b),(a, c),(b, c),(b, d),(c, d),(c, e),(d, e)}$. Uma representação gráfica deste grafo pode ser visto na Figura~\ref{Grafos01}.
\begin{figure}[htbp]
	\centering
...
\begin{figure}[htbp]
	...
	\caption[Exemplo de grafo não simples]{Exemplo de grafo com laços e arestas múltiplas.~\textit{Fonte: https://www.ic.unicamp.br/~zanoni/teaching/}}
	\label{Grafos02}
\end{figure}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=.3\textwidth]{Pictures/Grafos05}
