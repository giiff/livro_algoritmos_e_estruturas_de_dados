...
Um caminho Euleriano ou caminho de Euler, é um caminho em um grafo $G = {V,E}$, direcionado ou não, em que cada aresta só pode ser visitada uma única vez, enquanto os vértices pode ser visitados mais de uma vez.
Se o caminho de Euler inicia e termina em um mesmo vértice, então esses caminho é chamado de circuito ou ciclo de Euler.
