...
Dado um grafo $G = (V,E)$ e um vértice inicial $v_1$, a busca em largura explora todas as arestas de G para checar quais vŕtices são alcançáveis a partir de $v_1$.
Tipicamente a complexidade de tempo desse algoritmo é de $O(|V|)$ para percorrer o grafo inteiro~\cite{cormen2009}.
