...
Para grafos não-orientados, a matriz de adjacência é simétrica, de forma que nesses casos apenas é necessário o armazenamento dos elementos da diagonal principal e os elementos abaixo dela, por exemplo.
$$\begin{bmatrix}
\textbf{0} & ~ & ~ & ~ & ~ \\
\textbf{1} & \textbf{0} & ~ & ~ & ~ \\
...
Já a matriz de um grafo direcionado não será simétrica por a existência de uma aresta de $n_i$ para $n_j$ não implica na existência de uma aresta de $n_j$ para $n_i$.
